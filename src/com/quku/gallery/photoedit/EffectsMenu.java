...
/**
 * Effects menu that contains toggles mapping to corresponding groups of
 * effects.
 */
public class EffectsMenu extends RestorableView {
	...
	public interface OnToggleListener {
		...
		/**
		 * Listens to the selected status and mapped effects-id of the clicked
		 * toggle.
		 * 
		 * @return true to make the toggle selected; otherwise, make it
		 *         unselected.
		 */
