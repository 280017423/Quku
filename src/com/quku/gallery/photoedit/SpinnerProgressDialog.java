 ...
 * after it shows up and and re-enables them after it dismisses; this class
 * along with all its methods should be accessed in only UI thread and allows
...
public class SpinnerProgressDialog extends Dialog {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		// Pass touch events to tools for killing idle even when the progress
		// dialog is shown.
