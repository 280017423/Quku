...
public class BookLayout extends FrameLayout {
	...
	static int position;
	//页面宽
	public static final int PAGE_WIDTH = 682;
//	private DisplayMetrics dm;
	//页面高
	public static final int PAGE_HEIGHT = SystemDef.System.IMG_PICTURE_WIDTH;
	//底层
...
//		this.position = currentPage;
	...
	void refresh(){
		...
		showList = new ArrayList<SinglePage>();
